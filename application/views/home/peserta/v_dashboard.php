										...
										<div class="d-flex align-items-end justify-content-between bg-white px-4  pt-2 pb-4 rounded-bottom shadow-sm ">
											<div class="d-flex align-items-center">
												<div class="mr-2 position-relative d-flex justify-content-end align-items-end mt-n5">
													<img src="<?= base_url('assets/images/users/' . $data['foto']); ?>" class="avatar-xl rounded-circle border-width-4 border-white" alt="">
												</div>
												<div class="lh-1">
													<h2 class="mb-0">
														<?= $data['nama_lengkap']; ?>
									...
									<div class="col-md-12">
										...
										<ul class="nav nav-lb-tab mb-6" id="tab" role="tablist">
											<li class="nav-item ml-0" role="presentation">
												<a class="nav-link active " id="kwu-tab" data-toggle="pill" href="#kwu" role="tab" aria-controls="kwu" aria-selected="true">Beranda </a>
											</li>
											<li class="nav-item" role="presentation">
												<a class="nav-link" id="gld-tab" data-toggle="pill" href="#gld" role="tab" aria-controls="gld" aria-selected="false">Produk</a>
											</li>
											<li class="nav-item" role="presentation">
												<a class="nav-link" id="startupacademy-tab" data-toggle="pill" href="#startupacademy" role="tab" aria-controls="startupacademy" aria-selected="false">
													Info Tim</a>
											</li>
											<li class="nav-item" role="presentation">
												<a class="nav-link" id="prainkkubasikompetisi-tab" data-toggle="pill" href="#prainkkubasikompetisi" role="tab" aria-controls="prainkkubasikompetisi" aria-selected="false">
													Riwayat Perkuliahan</a>
											</li>
											<li class="nav-item" role="presentation">
												<a class="nav-link" id="inkkubasi-tab" data-toggle="pill" href="#inkubasi" role="tab" aria-controls="inkubasi" aria-selected="false">
													Acara</a>
											</li>
										</ul>
										<!-- Tab content -->
												...
												<div class="row  d-flex justify-content-center text-center">
													<div class="col-xl-5 col-lg-5 col-md-12 col-12">
														<div class="py-6">
															...
															<div class="mt-4 ">
																<h2 class="display-4 font-weight-bold">Akan dirilis segera!</h2>
																<p class="mb-5">Tim Pengembang sedang melakukan pembaruan website. Mohon bersabar dan Terima Kasih telah menunggu.</p>
																<a href="../index.html" class="btn btn-primary">
																	Kembali ke Laman Dashboard
																</a>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-12 col-md-12 col-12">
													<div class="row">
														...
														<div class="col-lg-3 col-md-3 col-12">
															...
															<div class="card mb-3">
																<div class="p-4">
																	<span class="font-size-xs text-uppercase font-weight-semi-bold">Acara</span>
																	<h2 class="mt-4 font-weight-bold mb-1 d-flex align-items-center h1 lh-1">
																		3
																	</h2>
																	<span class="d-flex justify-content-between align-items-center">
														...
														<tbody>
															...
															?>
																<tr>
																	...
																	<td class="text-muted ">
																		<span class="dropdown">
																			<a class="text-muted text-decoration-none" href="#!" role="button" id="courseDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																				<i class="fe fe-more-vertical"></i>
																			</a>
													...
													?>
														<div class="col-lg-3 col-md-6 col-12">
															...
															<div class="card  mb-4 card-hover">
																<a href="#!" class="card-img-top"><img src="../assets/images/course/course-graphql.jpg" alt="" class="card-img-top rounded-top"></a>
																<!-- Card body -->
																<div class="card-body">
